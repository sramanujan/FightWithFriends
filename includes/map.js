...
MAP_CONFIG.convertAbsoluteToTile = function(absolutePosition) {
    return {
        x: (absolutePosition.x + (NUM_TILES_LENGTH * TILE_LENGTH)/2 - TILE_LENGTH/2)/TILE_LENGTH,
        y: (absolutePosition.y + (NUM_TILES_BREADTH * TILE_BREADTH)/2 - TILE_BREADTH/2)/TILE_BREADTH
    }
};
