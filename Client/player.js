...
Entity = function(code, data, ownerId, isAIControlled, isDefender, index) {
    ...
    this.healthBar = new HealthBar(this.drawableObject, this.data.width, this.health, this.maxHealth, 0);
...
Projectile = function(code, sourceEntity, targetEntity) {
    ...
    this.drawableObject = new DrawableObject('projectile', this.code, sourceEntity.currentAbsolutePosition, this.data.width, this.data.height, this.data.frames, this);
    ...
    this.hasHit = false;
    this.drawableObject.playAnimation();
    this.lastMoved = new Date().getTime();
